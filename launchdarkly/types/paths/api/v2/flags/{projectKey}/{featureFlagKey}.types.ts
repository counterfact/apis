...
export type getFeatureFlag = (
  $: OmitValueWhenNever<{
    query: getFeatureFlag_Query;
    querystring: never;
    path: getFeatureFlag_Path;
    headers: getFeatureFlag_Headers;
    cookie: never;
    body: never;
    context: Context;
 ...
 *
 */
export type patchFeatureFlag = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: patchFeatureFlag_Path;
    headers: patchFeatureFlag_Headers;
    cookie: never;
 ...
 */
export type deleteFeatureFlag = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: deleteFeatureFlag_Path;
    headers: deleteFeatureFlag_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
...
export type getFeatureFlag_Query = {
  /**
...
export type getFeatureFlag_Path = {
  /**
   * The project key
   */
  projectKey: string;
...
export type getFeatureFlag_Headers = { Authorization: string };

export type patchFeatureFlag_Path = {
  /**
   * The project key
   */
  projectKey: string;
...
export type patchFeatureFlag_Headers = { Authorization: string };

export type deleteFeatureFlag_Path = {
  /**
   * The project key
   */
  projectKey: string;
...
export type deleteFeatureFlag_Headers = { Authorization: string };
