 ...
 */
export type postApprovalRequestApply = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: postApprovalRequestApply_Path;
    headers: postApprovalRequestApply_Headers;
    cookie: never;
...
export type postApprovalRequestApply_Path = {
  /**
...
export type postApprovalRequestApply_Headers = { Authorization: string };
