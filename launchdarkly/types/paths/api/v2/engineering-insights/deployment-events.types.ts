...
import type { PostDeploymentEventInput } from "../../../../components/schemas/PostDeploymentEventInput.js";
 ...
 */
export type createDeploymentEvent = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: createDeploymentEvent_Headers;
    cookie: never;
    body: PostDeploymentEventInput;
    context: Context;
...
export type createDeploymentEvent_Headers = { Authorization: string };
