 ...
 */
export type getFlagStatusChart = (
  $: OmitValueWhenNever<{
    query: getFlagStatusChart_Query;
    querystring: never;
    path: never;
    headers: getFlagStatusChart_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type getFlagStatusChart_Query = {
  /**
   * The project key
   */
  projectKey: string;
...
export type getFlagStatusChart_Headers = { Authorization: string };
