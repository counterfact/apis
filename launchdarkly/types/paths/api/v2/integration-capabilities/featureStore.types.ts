 ...
 */
export type getIntegrationDeliveryConfigurations = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: getIntegrationDeliveryConfigurations_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type getIntegrationDeliveryConfigurations_Headers = {
