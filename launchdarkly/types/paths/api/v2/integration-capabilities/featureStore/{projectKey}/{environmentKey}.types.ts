...
import type { IntegrationDeliveryConfigurationCollection } from "../../../../../../components/schemas/IntegrationDeliveryConfigurationCollection.js";
 ...
 */
export type getIntegrationDeliveryConfigurationByEnvironment = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: getIntegrationDeliveryConfigurationByEnvironment_Path;
    headers: getIntegrationDeliveryConfigurationByEnvironment_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: IntegrationDeliveryConfigurationCollection;
          };
        };
        examples: {};
      };
...
export type getIntegrationDeliveryConfigurationByEnvironment_Path = {
  /**
   * The project key
   */
  projectKey: string;
...
export type getIntegrationDeliveryConfigurationByEnvironment_Headers = {
