...
import type { BigSegmentStoreIntegrationCollection } from "../../../../components/schemas/BigSegmentStoreIntegrationCollection.js";
 ...
 */
export type getBigSegmentStoreIntegrations = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: getBigSegmentStoreIntegrations_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: BigSegmentStoreIntegrationCollection;
          };
        };
        examples: {};
      };
...
export type getBigSegmentStoreIntegrations_Headers = { Authorization: string };
