 ...
 */
export type getContextInstances = (
  $: OmitValueWhenNever<{
    query: getContextInstances_Query;
    querystring: never;
    path: getContextInstances_Path;
    headers: getContextInstances_Headers;
    cookie: never;
    body: never;
    context: Context;
 ...
 */
export type deleteContextInstances = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: deleteContextInstances_Path;
    headers: deleteContextInstances_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
...
export type getContextInstances_Query = {
  /**
...
export type getContextInstances_Path = {
  /**
   * The project key
   */
  projectKey: string;
...
export type getContextInstances_Headers = { Authorization: string };

export type deleteContextInstances_Path = {
  /**
   * The project key
   */
  projectKey: string;
...
export type deleteContextInstances_Headers = { Authorization: string };
