...
import type { UpsertContextKindPayload } from "../../../../../../components/schemas/UpsertContextKindPayload.js";
import type { UpsertResponseRep } from "../../../../../../components/schemas/UpsertResponseRep.js";
 ...
 */
export type putContextKind = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: putContextKind_Path;
    headers: putContextKind_Headers;
    cookie: never;
    body: UpsertContextKindPayload;
    context: Context;
...
export type putContextKind_Path = {
  /**
   * The project key
   */
  projectKey: string;
...
export type putContextKind_Headers = { Authorization: string };
