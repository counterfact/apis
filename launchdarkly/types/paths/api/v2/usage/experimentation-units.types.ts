 ...
 */
export type getExperimentationUnitsUsage = (
  $: OmitValueWhenNever<{
    query: getExperimentationUnitsUsage_Query;
    querystring: never;
    path: never;
    headers: getExperimentationUnitsUsage_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type getExperimentationUnitsUsage_Query = {
  /**
...
export type getExperimentationUnitsUsage_Headers = { Authorization: string };
