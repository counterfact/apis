 ...
 */
export type getEvaluationsUsage = (
  $: OmitValueWhenNever<{
    query: getEvaluationsUsage_Query;
    querystring: never;
    path: getEvaluationsUsage_Path;
    headers: getEvaluationsUsage_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type getEvaluationsUsage_Query = {
  /**
...
export type getEvaluationsUsage_Path = {
  /**
   * The project key
   */
  projectKey: string;
...
export type getEvaluationsUsage_Headers = { Authorization: string };
