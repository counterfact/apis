 ...
 */
export type getExperimentationKeysUsage = (
  $: OmitValueWhenNever<{
    query: getExperimentationKeysUsage_Query;
    querystring: never;
    path: never;
    headers: getExperimentationKeysUsage_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type getExperimentationKeysUsage_Query = {
  /**
...
export type getExperimentationKeysUsage_Headers = { Authorization: string };
