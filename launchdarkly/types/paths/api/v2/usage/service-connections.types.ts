 ...
 */
export type getServiceConnectionUsage = (
  $: OmitValueWhenNever<{
    query: getServiceConnectionUsage_Query;
    querystring: never;
    path: never;
    headers: getServiceConnectionUsage_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type getServiceConnectionUsage_Query = {
  /**
...
export type getServiceConnectionUsage_Headers = { Authorization: string };
