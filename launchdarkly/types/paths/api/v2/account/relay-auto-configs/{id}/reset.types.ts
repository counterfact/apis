 ...
 */
export type resetRelayAutoConfig = (
  $: OmitValueWhenNever<{
    query: resetRelayAutoConfig_Query;
    querystring: never;
    path: resetRelayAutoConfig_Path;
    headers: resetRelayAutoConfig_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type resetRelayAutoConfig_Query = {
  /**
...
export type resetRelayAutoConfig_Path = {
  /**
...
export type resetRelayAutoConfig_Headers = { Authorization: string };
