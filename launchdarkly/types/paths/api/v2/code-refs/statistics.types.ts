...
import type { StatisticsRoot } from "../../../../components/schemas/StatisticsRoot.js";
 ...
 */
export type getRootStatistic = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: getRootStatistic_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type getRootStatistic_Headers = { Authorization: string };
