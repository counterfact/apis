 ...
 */
export type deleteBranches = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: deleteBranches_Path;
    headers: deleteBranches_Headers;
    cookie: never;
    body: Array<string>;
    context: Context;
...
export type deleteBranches_Path = {
  /**
...
export type deleteBranches_Headers = { Authorization: string };
