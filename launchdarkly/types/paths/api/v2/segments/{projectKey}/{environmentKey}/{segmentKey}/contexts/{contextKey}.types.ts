 ...
 */
export type getSegmentMembershipForContext = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: getSegmentMembershipForContext_Path;
    headers: getSegmentMembershipForContext_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type getSegmentMembershipForContext_Path = {
  /**
   * The project key
   */
  projectKey: string;
...
export type getSegmentMembershipForContext_Headers = { Authorization: string };
