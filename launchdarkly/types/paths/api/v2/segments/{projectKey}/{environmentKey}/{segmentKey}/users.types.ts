 ...
 */
export type updateBigSegmentTargets = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: updateBigSegmentTargets_Path;
    headers: updateBigSegmentTargets_Headers;
    cookie: never;
...
export type updateBigSegmentTargets_Path = {
  /**
   * The project key
   */
  projectKey: string;
...
export type updateBigSegmentTargets_Headers = { Authorization: string };
