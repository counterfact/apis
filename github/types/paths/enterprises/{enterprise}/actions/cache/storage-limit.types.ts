...
import type { actions_cache_storage_limit_for_enterprise } from "../../../../../components/schemas/actions-cache-storage-limit-for-enterprise.js";
 ...
 */
export type actionsGetActionsCacheStorageLimitForEnterprise = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsGetActionsCacheStorageLimitForEnterprise_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: actions_cache_storage_limit_for_enterprise;
          };
        };
        examples: {
          default: unknown;
 ...
 * OAuth tokens and personal access tokens (classic) need the `admin:enterprise` scope to use this endpoint.
 */
export type actionsSetActionsCacheStorageLimitForEnterprise = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsSetActionsCacheStorageLimitForEnterprise_Path;
    headers: never;
    cookie: never;
    body: actions_cache_storage_limit_for_enterprise;
    context: Context;
    response: ResponseBuilderFactory<{
      204: {
        headers: never;
...
export type actionsGetActionsCacheStorageLimitForEnterprise_Path = {
  enterprise: string;
};

export type actionsSetActionsCacheStorageLimitForEnterprise_Path = {
  enterprise: string;
};
