 ...
 */
export type enterpriseTeamOrganizationsBulkRemove = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: enterpriseTeamOrganizationsBulkRemove_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type enterpriseTeamOrganizationsBulkRemove_Path = {
  enterprise: string;
