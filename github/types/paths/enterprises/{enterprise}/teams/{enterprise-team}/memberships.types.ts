 ...
 */
export type enterpriseTeamMembershipsList = (
  $: OmitValueWhenNever<{
    query: enterpriseTeamMembershipsList_Query;
    querystring: never;
    path: enterpriseTeamMembershipsList_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type enterpriseTeamMembershipsList_Query = {
  per_page?: number;
  page?: number;
};

export type enterpriseTeamMembershipsList_Path = {
  enterprise: string;
