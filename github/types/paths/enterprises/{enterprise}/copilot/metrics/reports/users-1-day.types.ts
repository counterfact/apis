 ...
 */
export type copilotCopilotUsersOneDayUsageMetrics = (
  $: OmitValueWhenNever<{
    query: copilotCopilotUsersOneDayUsageMetrics_Query;
    querystring: never;
    path: copilotCopilotUsersOneDayUsageMetrics_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type copilotCopilotUsersOneDayUsageMetrics_Query = { day: string };

export type copilotCopilotUsersOneDayUsageMetrics_Path = { enterprise: string };
