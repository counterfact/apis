 ...
 */
export type copilotCopilotEnterpriseOneDayUsageMetrics = (
  $: OmitValueWhenNever<{
    query: copilotCopilotEnterpriseOneDayUsageMetrics_Query;
    querystring: never;
    path: copilotCopilotEnterpriseOneDayUsageMetrics_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type copilotCopilotEnterpriseOneDayUsageMetrics_Query = { day: string };

export type copilotCopilotEnterpriseOneDayUsageMetrics_Path = {
  enterprise: string;
};
