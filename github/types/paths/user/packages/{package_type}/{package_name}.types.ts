...
export type packagesGetPackageForAuthenticatedUser = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: packagesGetPackageForAuthenticatedUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type packagesDeletePackageForAuthenticatedUser = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: packagesDeletePackageForAuthenticatedUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type packagesGetPackageForAuthenticatedUser_Path = {
  package_type: "npm" | "maven" | "rubygems" | "docker" | "nuget" | "container";
  package_name: string;
};

export type packagesDeletePackageForAuthenticatedUser_Path = {
  package_type: "npm" | "maven" | "rubygems" | "docker" | "nuget" | "container";
  package_name: string;
};
