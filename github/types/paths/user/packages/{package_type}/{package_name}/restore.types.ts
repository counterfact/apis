...
export type packagesRestorePackageForAuthenticatedUser = (
  $: OmitValueWhenNever<{
    query: packagesRestorePackageForAuthenticatedUser_Query;
    querystring: never;
    path: packagesRestorePackageForAuthenticatedUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type packagesRestorePackageForAuthenticatedUser_Query = {
  /**
   * package token
   */
  token?: string;
...
export type packagesRestorePackageForAuthenticatedUser_Path = {
