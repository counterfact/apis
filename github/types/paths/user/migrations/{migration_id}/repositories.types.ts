...
export type migrationsListReposForAuthenticatedUser = (
  $: OmitValueWhenNever<{
    query: migrationsListReposForAuthenticatedUser_Query;
    querystring: never;
    path: migrationsListReposForAuthenticatedUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type migrationsListReposForAuthenticatedUser_Query = {
  per_page?: number;
  page?: number;
};

export type migrationsListReposForAuthenticatedUser_Path = {
  migration_id: number;
};
