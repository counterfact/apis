...
export type usersGetGpgKeyForAuthenticatedUser = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: usersGetGpgKeyForAuthenticatedUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type usersDeleteGpgKeyForAuthenticatedUser = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: usersDeleteGpgKeyForAuthenticatedUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type usersGetGpgKeyForAuthenticatedUser_Path = { gpg_key_id: number };

export type usersDeleteGpgKeyForAuthenticatedUser_Path = { gpg_key_id: number };
