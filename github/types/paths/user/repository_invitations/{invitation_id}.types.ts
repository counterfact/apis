...
export type reposAcceptInvitationForAuthenticatedUser = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: reposAcceptInvitationForAuthenticatedUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type reposDeclineInvitationForAuthenticatedUser = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: reposDeclineInvitationForAuthenticatedUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type reposAcceptInvitationForAuthenticatedUser_Path = {
  invitation_id: number;
};

export type reposDeclineInvitationForAuthenticatedUser_Path = {
  invitation_id: number;
};
