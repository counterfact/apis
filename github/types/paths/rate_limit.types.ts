...
import type { rate_limit_overview } from "../components/schemas/rate-limit-overview.js";
...
export type rateLimitGet = (
  $: OmitValueWhenNever<{
    ...
    response: ResponseBuilderFactory<{
      200: {
        headers: {
          "X-RateLimit-Limit": { schema: number };
          "X-RateLimit-Remaining": { schema: number };
          "X-RateLimit-Reset": { schema: number };
        };
        requiredHeaders: never;
        content: {
          "application/json": {
            schema: rate_limit_overview;
          };
        };
        examples: {
          default: unknown;
