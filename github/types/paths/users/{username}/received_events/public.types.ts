...
export type activityListReceivedPublicEventsForUser = (
  $: OmitValueWhenNever<{
    query: activityListReceivedPublicEventsForUser_Query;
    querystring: never;
    path: activityListReceivedPublicEventsForUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type activityListReceivedPublicEventsForUser_Query = {
  per_page?: number;
  page?: number;
};

export type activityListReceivedPublicEventsForUser_Path = { username: string };
