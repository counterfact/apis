 ...
 */
export type projectsListItemsForUser = (
  $: OmitValueWhenNever<{
    query: projectsListItemsForUser_Query;
    querystring: never;
    path: projectsListItemsForUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
 ...
 */
export type projectsAddItemForUser = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: projectsAddItemForUser_Path;
    headers: never;
    cookie: never;
...
export type projectsListItemsForUser_Query = {
  before?: string;
  after?: string;
  per_page?: number;
  /**
...
export type projectsListItemsForUser_Path = {
  project_number: number;
  username: string;
};

export type projectsAddItemForUser_Path = {
  username: string;
  project_number: number;
};
