...
export type activityListReposWatchedByUser = (
  $: OmitValueWhenNever<{
    query: activityListReposWatchedByUser_Query;
    querystring: never;
    path: activityListReposWatchedByUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type activityListReposWatchedByUser_Query = {
  per_page?: number;
  page?: number;
};

export type activityListReposWatchedByUser_Path = { username: string };
