...
export type packagesGetPackageVersionForUser = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: packagesGetPackageVersionForUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type packagesDeletePackageVersionForUser = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: packagesDeletePackageVersionForUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type packagesGetPackageVersionForUser_Path = {
...
export type packagesDeletePackageVersionForUser_Path = {
  package_type: "npm" | "maven" | "rubygems" | "docker" | "nuget" | "container";
  package_name: string;
  username: string;
  package_version_id: number;
