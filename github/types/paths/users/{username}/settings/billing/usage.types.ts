...
import type { billing_usage_report_user } from "../../../../../#/components/responses/billing_usage_report_user.js";
...
export type billingGetGithubBillingUsageReportUser = (
  $: OmitValueWhenNever<{
    query: billingGetGithubBillingUsageReportUser_Query;
    querystring: never;
    path: billingGetGithubBillingUsageReportUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: billing_usage_report_user;
      400: bad_request;
      403: forbidden;
      500: internal_error;
...
export type billingGetGithubBillingUsageReportUser_Query = {
  year?: number;
  month?: number;
  day?: number;
};

export type billingGetGithubBillingUsageReportUser_Path = { username: string };
