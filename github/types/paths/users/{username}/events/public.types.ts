...
export type activityListPublicEventsForUser = (
  $: OmitValueWhenNever<{
    query: activityListPublicEventsForUser_Query;
    querystring: never;
    path: activityListPublicEventsForUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type activityListPublicEventsForUser_Query = {
  per_page?: number;
  page?: number;
};

export type activityListPublicEventsForUser_Path = { username: string };
