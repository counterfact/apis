...
export type usersListFollowersForUser = (
  $: OmitValueWhenNever<{
    query: usersListFollowersForUser_Query;
    querystring: never;
    path: usersListFollowersForUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type usersListFollowersForUser_Query = {
  per_page?: number;
  page?: number;
};

export type usersListFollowersForUser_Path = { username: string };
