...
export type activityListReceivedEventsForUser = (
  $: OmitValueWhenNever<{
    query: activityListReceivedEventsForUser_Query;
    querystring: never;
    path: activityListReceivedEventsForUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type activityListReceivedEventsForUser_Query = {
  per_page?: number;
  page?: number;
};

export type activityListReceivedEventsForUser_Path = { username: string };
