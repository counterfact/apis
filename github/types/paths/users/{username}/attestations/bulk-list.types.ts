...
export type usersListAttestationsBulk = (
  $: OmitValueWhenNever<{
    query: usersListAttestationsBulk_Query;
    querystring: never;
    path: usersListAttestationsBulk_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type usersListAttestationsBulk_Query = {
  per_page?: number;
  before?: string;
  after?: string;
};

export type usersListAttestationsBulk_Path = { username: string };
