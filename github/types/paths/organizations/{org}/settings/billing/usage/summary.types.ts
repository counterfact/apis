...
import type { billing_usage_summary_report_org } from "../../../../../../#/components/responses/billing_usage_summary_report_org.js";
 ...
 */
export type billingGetGithubBillingUsageSummaryReportOrg = (
  $: OmitValueWhenNever<{
    query: billingGetGithubBillingUsageSummaryReportOrg_Query;
    querystring: never;
    path: billingGetGithubBillingUsageSummaryReportOrg_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: billing_usage_summary_report_org;
      400: bad_request;
      403: forbidden;
      500: internal_error;
...
export type billingGetGithubBillingUsageSummaryReportOrg_Query = {
  year?: number;
  month?: number;
  day?: number;
  repository?: string;
...
export type billingGetGithubBillingUsageSummaryReportOrg_Path = { org: string };
