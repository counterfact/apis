...
import type { billing_premium_request_usage_report_org } from "../../../../../../#/components/responses/billing_premium_request_usage_report_org.js";
 ...
 */
export type billingGetGithubBillingPremiumRequestUsageReportOrg = (
  $: OmitValueWhenNever<{
    query: billingGetGithubBillingPremiumRequestUsageReportOrg_Query;
    querystring: never;
    path: billingGetGithubBillingPremiumRequestUsageReportOrg_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: billing_premium_request_usage_report_org;
      400: bad_request;
      403: forbidden;
      404: not_found;
      500: internal_error;
...
export type billingGetGithubBillingPremiumRequestUsageReportOrg_Query = {
  year?: number;
  month?: number;
  day?: number;
  user?: string;
...
export type billingGetGithubBillingPremiumRequestUsageReportOrg_Path = {
  org: string;
};
