...
export type dependabotListOrgSecrets = (
  $: OmitValueWhenNever<{
    query: dependabotListOrgSecrets_Query;
    querystring: never;
    path: dependabotListOrgSecrets_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type dependabotListOrgSecrets_Query = {
  per_page?: number;
  page?: number;
};

export type dependabotListOrgSecrets_Path = { org: string };
