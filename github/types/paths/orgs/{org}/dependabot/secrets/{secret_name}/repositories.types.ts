...
export type dependabotListSelectedReposForOrgSecret = (
  $: OmitValueWhenNever<{
    query: dependabotListSelectedReposForOrgSecret_Query;
    querystring: never;
    path: dependabotListSelectedReposForOrgSecret_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type dependabotSetSelectedReposForOrgSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: dependabotSetSelectedReposForOrgSecret_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type dependabotListSelectedReposForOrgSecret_Query = {
  page?: number;
  per_page?: number;
};

export type dependabotListSelectedReposForOrgSecret_Path = {
  org: string;
  secret_name: string;
};

export type dependabotSetSelectedReposForOrgSecret_Path = {
  org: string;
  secret_name: string;
};
