...
export type dependabotAddSelectedRepoToOrgSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: dependabotAddSelectedRepoToOrgSecret_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type dependabotRemoveSelectedRepoFromOrgSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: dependabotRemoveSelectedRepoFromOrgSecret_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type dependabotAddSelectedRepoToOrgSecret_Path = {
  org: string;
  secret_name: string;
  repository_id: number;
};

export type dependabotRemoveSelectedRepoFromOrgSecret_Path = {
  org: string;
  secret_name: string;
  repository_id: number;
};
