...
import type { organization_update_issue_type } from "../../../../components/schemas/organization-update-issue-type.js";
...
export type orgsUpdateIssueType = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: orgsUpdateIssueType_Path;
    headers: never;
    cookie: never;
    body: organization_update_issue_type;
    context: Context;
...
export type orgsUpdateIssueType_Path = { org: string; issue_type_id: number };

export type orgsDeleteIssueType_Path = { org: string; issue_type_id: number };
