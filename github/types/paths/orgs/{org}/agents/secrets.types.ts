 ...
 */
export type agentsListOrgSecrets = (
  $: OmitValueWhenNever<{
    query: agentsListOrgSecrets_Query;
    querystring: never;
    path: agentsListOrgSecrets_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type agentsListOrgSecrets_Query = { per_page?: number; page?: number };

export type agentsListOrgSecrets_Path = { org: string };
