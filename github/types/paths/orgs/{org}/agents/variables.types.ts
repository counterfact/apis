 ...
 */
export type agentsListOrgVariables = (
  $: OmitValueWhenNever<{
    query: agentsListOrgVariables_Query;
    querystring: never;
    path: agentsListOrgVariables_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
 ...
 */
export type agentsCreateOrgVariable = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: agentsCreateOrgVariable_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type agentsListOrgVariables_Query = { per_page?: number; page?: number };

export type agentsListOrgVariables_Path = { org: string };

export type agentsCreateOrgVariable_Path = { org: string };
