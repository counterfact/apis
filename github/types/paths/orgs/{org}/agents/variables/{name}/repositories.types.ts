 ...
 */
export type agentsListSelectedReposForOrgVariable = (
  $: OmitValueWhenNever<{
    query: agentsListSelectedReposForOrgVariable_Query;
    querystring: never;
    path: agentsListSelectedReposForOrgVariable_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
 ...
 * OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint. If the repository is private, the `repo` scope is also required.
 */
export type agentsSetSelectedReposForOrgVariable = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: agentsSetSelectedReposForOrgVariable_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type agentsListSelectedReposForOrgVariable_Query = {
  page?: number;
  per_page?: number;
};

export type agentsListSelectedReposForOrgVariable_Path = {
  org: string;
  name: string;
};

export type agentsSetSelectedReposForOrgVariable_Path = {
  org: string;
  name: string;
};
