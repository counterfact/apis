 ...
 */
export type agentsAddSelectedRepoToOrgVariable = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: agentsAddSelectedRepoToOrgVariable_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
 ...
 */
export type agentsRemoveSelectedRepoFromOrgVariable = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: agentsRemoveSelectedRepoFromOrgVariable_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type agentsAddSelectedRepoToOrgVariable_Path = {
  org: string;
  name: string;
  repository_id: number;
};

export type agentsRemoveSelectedRepoFromOrgVariable_Path = {
  org: string;
  name: string;
  repository_id: number;
};
