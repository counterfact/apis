 ...
 */
export type agentsListSelectedReposForOrgSecret = (
  $: OmitValueWhenNever<{
    query: agentsListSelectedReposForOrgSecret_Query;
    querystring: never;
    path: agentsListSelectedReposForOrgSecret_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
 ...
 * OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint. If the repository is private, the `repo` scope is also required.
 */
export type agentsSetSelectedReposForOrgSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: agentsSetSelectedReposForOrgSecret_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type agentsListSelectedReposForOrgSecret_Query = {
  page?: number;
  per_page?: number;
};

export type agentsListSelectedReposForOrgSecret_Path = {
  org: string;
  secret_name: string;
};

export type agentsSetSelectedReposForOrgSecret_Path = {
  org: string;
  secret_name: string;
};
