 ...
 */
export type agentsAddSelectedRepoToOrgSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: agentsAddSelectedRepoToOrgSecret_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
 ...
 */
export type agentsRemoveSelectedRepoFromOrgSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: agentsRemoveSelectedRepoFromOrgSecret_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type agentsAddSelectedRepoToOrgSecret_Path = {
  org: string;
  secret_name: string;
  repository_id: number;
};

export type agentsRemoveSelectedRepoFromOrgSecret_Path = {
  org: string;
  secret_name: string;
  repository_id: number;
};
