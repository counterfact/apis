 ...
 */
export type agentsGetOrgSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: agentsGetOrgSecret_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: organization_actions_secret;
          };
        };
        examples: {
          default: unknown;
 ...
 * OAuth tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint. If the repository is private, OAuth tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.
 */
export type agentsCreateOrUpdateOrgSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: agentsCreateOrUpdateOrgSecret_Path;
    headers: never;
    cookie: never;
    body: {
      /**
 ...
 * OAuth tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint. If the repository is private, OAuth tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.
 */
export type agentsDeleteOrgSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: agentsDeleteOrgSecret_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type agentsGetOrgSecret_Path = { org: string; secret_name: string };

export type agentsCreateOrUpdateOrgSecret_Path = {
  org: string;
  secret_name: string;
};

export type agentsDeleteOrgSecret_Path = { org: string; secret_name: string };
