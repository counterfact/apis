...
export type packagesGetAllPackageVersionsForPackageOwnedByOrg = (
  $: OmitValueWhenNever<{
    query: packagesGetAllPackageVersionsForPackageOwnedByOrg_Query;
    querystring: never;
    path: packagesGetAllPackageVersionsForPackageOwnedByOrg_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type packagesGetAllPackageVersionsForPackageOwnedByOrg_Query = {
  page?: number;
  per_page?: number;
  /**
...
export type packagesGetAllPackageVersionsForPackageOwnedByOrg_Path = {
