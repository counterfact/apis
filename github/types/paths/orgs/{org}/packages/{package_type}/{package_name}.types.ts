...
export type packagesGetPackageForOrganization = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: packagesGetPackageForOrganization_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type packagesDeletePackageForOrg = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: packagesDeletePackageForOrg_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type packagesGetPackageForOrganization_Path = {
  package_type: "npm" | "maven" | "rubygems" | "docker" | "nuget" | "container";
  package_name: string;
  org: string;
};

export type packagesDeletePackageForOrg_Path = {
  package_type: "npm" | "maven" | "rubygems" | "docker" | "nuget" | "container";
  package_name: string;
  org: string;
};
