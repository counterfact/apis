...
export type orgsListPublicMembers = (
  $: OmitValueWhenNever<{
    query: orgsListPublicMembers_Query;
    querystring: never;
    path: orgsListPublicMembers_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type orgsListPublicMembers_Query = { per_page?: number; page?: number };

export type orgsListPublicMembers_Path = { org: string };
