 ...
 */
export type projectsGetOrgItem = (
  $: OmitValueWhenNever<{
    query: projectsGetOrgItem_Query;
    querystring: never;
    path: projectsGetOrgItem_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
 ...
 */
export type projectsUpdateItemForOrg = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: projectsUpdateItemForOrg_Path;
    headers: never;
    cookie: never;
    body: {
      /**
 ...
 */
export type projectsDeleteItemForOrg = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: projectsDeleteItemForOrg_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type projectsGetOrgItem_Query = {
  /**
...
export type projectsGetOrgItem_Path = {
  project_number: number;
  org: string;
  item_id: number;
};

export type projectsUpdateItemForOrg_Path = {
  project_number: number;
  org: string;
  item_id: number;
};

export type projectsDeleteItemForOrg_Path = {
  project_number: number;
  org: string;
  item_id: number;
};
