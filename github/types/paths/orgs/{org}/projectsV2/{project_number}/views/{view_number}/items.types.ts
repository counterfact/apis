 ...
 */
export type projectsListViewItemsForOrg = (
  $: OmitValueWhenNever<{
    query: projectsListViewItemsForOrg_Query;
    querystring: never;
    path: projectsListViewItemsForOrg_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type projectsListViewItemsForOrg_Query = {
  /**
...
export type projectsListViewItemsForOrg_Path = {
