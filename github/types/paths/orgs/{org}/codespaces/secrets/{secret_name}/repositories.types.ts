...
export type codespacesListSelectedReposForOrgSecret = (
  $: OmitValueWhenNever<{
    query: codespacesListSelectedReposForOrgSecret_Query;
    querystring: never;
    path: codespacesListSelectedReposForOrgSecret_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type codespacesSetSelectedReposForOrgSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: codespacesSetSelectedReposForOrgSecret_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type codespacesListSelectedReposForOrgSecret_Query = {
  page?: number;
  per_page?: number;
};

export type codespacesListSelectedReposForOrgSecret_Path = {
  org: string;
  secret_name: string;
};

export type codespacesSetSelectedReposForOrgSecret_Path = {
  org: string;
  secret_name: string;
};
