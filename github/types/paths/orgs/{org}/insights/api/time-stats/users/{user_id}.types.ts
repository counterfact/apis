...
export type apiInsightsGetTimeStatsByUser = (
  $: OmitValueWhenNever<{
    query: apiInsightsGetTimeStatsByUser_Query;
    querystring: never;
    path: apiInsightsGetTimeStatsByUser_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type apiInsightsGetTimeStatsByUser_Query = {
  min_timestamp: string;
  max_timestamp?: string;
  timestamp_increment: string;
};

export type apiInsightsGetTimeStatsByUser_Path = {
  org: string;
  user_id: string;
};
