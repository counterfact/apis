...
export type codespacesGetCodespacesForUserInOrg = (
  $: OmitValueWhenNever<{
    query: codespacesGetCodespacesForUserInOrg_Query;
    querystring: never;
    path: codespacesGetCodespacesForUserInOrg_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type codespacesGetCodespacesForUserInOrg_Query = {
  per_page?: number;
  page?: number;
};

export type codespacesGetCodespacesForUserInOrg_Path = {
  org: string;
  username: string;
};
