...
export type orgsListWebhookDeliveries = (
  $: OmitValueWhenNever<{
    query: orgsListWebhookDeliveries_Query;
    querystring: never;
    path: orgsListWebhookDeliveries_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type orgsListWebhookDeliveries_Query = {
  per_page?: number;
  cursor?: string;
  status?: "success" | "failure";
};

export type orgsListWebhookDeliveries_Path = { org: string; hook_id: number };
