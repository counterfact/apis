...
export type reposUpdateOrgRuleset = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: reposUpdateOrgRuleset_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type reposDeleteOrgRuleset = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: reposDeleteOrgRuleset_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type reposGetOrgRuleset_Path = {
  org: string;
  /**
...
export type reposUpdateOrgRuleset_Path = {
  org: string;
  /**
   * The ID of the ruleset.
   */
...
export type reposDeleteOrgRuleset_Path = {
  org: string;
  /**
   * The ID of the ruleset.
   */
