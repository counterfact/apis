...
export type orgsGetOrgRulesetHistory = (
  $: OmitValueWhenNever<{
    query: orgsGetOrgRulesetHistory_Query;
    querystring: never;
    path: orgsGetOrgRulesetHistory_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type orgsGetOrgRulesetHistory_Query = {
  per_page?: number;
  page?: number;
};

export type orgsGetOrgRulesetHistory_Path = {
  org: string;
  /**
