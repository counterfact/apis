...
export type copilotAddCopilotSeatsForTeams = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: copilotAddCopilotSeatsForTeams_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type copilotCancelCopilotSeatAssignmentForTeams = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: copilotCancelCopilotSeatAssignmentForTeams_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type copilotAddCopilotSeatsForTeams_Path = { org: string };

export type copilotCancelCopilotSeatAssignmentForTeams_Path = { org: string };
