 ...
 */
export type copilotCopilotOrganizationUsageMetrics = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: copilotCopilotOrganizationUsageMetrics_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type copilotCopilotOrganizationUsageMetrics_Path = { org: string };
