 ...
 */
export type copilotCopilotOrganizationOneDayUsageMetrics = (
  $: OmitValueWhenNever<{
    query: copilotCopilotOrganizationOneDayUsageMetrics_Query;
    querystring: never;
    path: copilotCopilotOrganizationOneDayUsageMetrics_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type copilotCopilotOrganizationOneDayUsageMetrics_Query = {
  day: string;
};

export type copilotCopilotOrganizationOneDayUsageMetrics_Path = { org: string };
