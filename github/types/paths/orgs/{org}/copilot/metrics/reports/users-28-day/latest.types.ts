 ...
 */
export type copilotCopilotOrganizationUsersUsageMetrics = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: copilotCopilotOrganizationUsersUsageMetrics_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type copilotCopilotOrganizationUsersUsageMetrics_Path = { org: string };
