...
export type copilotCopilotMetricsForOrganization = (
  $: OmitValueWhenNever<{
    query: copilotCopilotMetricsForOrganization_Query;
    querystring: never;
    path: copilotCopilotMetricsForOrganization_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type copilotCopilotMetricsForOrganization_Query = {
  /**
...
export type copilotCopilotMetricsForOrganization_Path = { org: string };
