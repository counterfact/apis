 ...
 */
export type copilotEnableCopilotCodingAgentForRepositoryInOrganization = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: copilotEnableCopilotCodingAgentForRepositoryInOrganization_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
 ...
 */
export type copilotDisableCopilotCodingAgentForRepositoryInOrganization = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: copilotDisableCopilotCodingAgentForRepositoryInOrganization_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type copilotEnableCopilotCodingAgentForRepositoryInOrganization_Path = {
  org: string;
  repository_id: number;
};

export type copilotDisableCopilotCodingAgentForRepositoryInOrganization_Path = {
  org: string;
  repository_id: number;
};
