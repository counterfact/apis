 ...
 */
export type actionsGetForkPrContributorApprovalPermissionsOrganization = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsGetForkPrContributorApprovalPermissionsOrganization_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
 ...
 */
export type actionsSetForkPrContributorApprovalPermissionsOrganization = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsSetForkPrContributorApprovalPermissionsOrganization_Path;
    headers: never;
    cookie: never;
...
export type actionsGetForkPrContributorApprovalPermissionsOrganization_Path = {
  org: string;
};

export type actionsSetForkPrContributorApprovalPermissionsOrganization_Path = {
  org: string;
};
