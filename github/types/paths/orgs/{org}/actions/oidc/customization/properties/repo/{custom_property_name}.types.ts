 ...
 */
export type oidcDeleteOidcCustomPropertyInclusionForOrg = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: oidcDeleteOidcCustomPropertyInclusionForOrg_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type oidcDeleteOidcCustomPropertyInclusionForOrg_Path = {
  org: string;
  /**
