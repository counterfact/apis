...
export type actionsAddSelfHostedRunnerToGroupForOrg = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsAddSelfHostedRunnerToGroupForOrg_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type actionsRemoveSelfHostedRunnerFromGroupForOrg = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsRemoveSelfHostedRunnerFromGroupForOrg_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type actionsAddSelfHostedRunnerToGroupForOrg_Path = {
  org: string;
  runner_group_id: number;
  runner_id: number;
};

export type actionsRemoveSelfHostedRunnerFromGroupForOrg_Path = {
  org: string;
  runner_group_id: number;
  runner_id: number;
};
