...
export type actionsCreateOrUpdateOrgSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsCreateOrUpdateOrgSecret_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type actionsDeleteOrgSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsDeleteOrgSecret_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type actionsGetOrgSecret_Path = { org: string; secret_name: string };

export type actionsCreateOrUpdateOrgSecret_Path = {
  org: string;
  secret_name: string;
};

export type actionsDeleteOrgSecret_Path = { org: string; secret_name: string };
