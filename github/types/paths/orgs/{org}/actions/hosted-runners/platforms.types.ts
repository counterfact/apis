...
export type actionsGetHostedRunnersPlatformsForOrg = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsGetHostedRunnersPlatformsForOrg_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: { total_count: number; platforms: Array<string> };
          };
        };
        examples: {
          default: unknown;
...
export type actionsGetHostedRunnersPlatformsForOrg_Path = { org: string };
