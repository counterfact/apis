...
import type { actions_hosted_runner_limits } from "../../../../../components/schemas/actions-hosted-runner-limits.js";
...
export type actionsGetHostedRunnersLimitsForOrg = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsGetHostedRunnersLimitsForOrg_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: actions_hosted_runner_limits;
          };
        };
        examples: {
          default: unknown;
...
export type actionsGetHostedRunnersLimitsForOrg_Path = { org: string };
