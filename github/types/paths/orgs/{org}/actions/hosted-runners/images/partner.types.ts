...
import type { actions_hosted_runner_curated_image } from "../../../../../../components/schemas/actions-hosted-runner-curated-image.js";
...
export type actionsGetHostedRunnersPartnerImagesForOrg = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsGetHostedRunnersPartnerImagesForOrg_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type actionsGetHostedRunnersPartnerImagesForOrg_Path = { org: string };
