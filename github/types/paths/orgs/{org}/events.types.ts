...
export type activityListPublicOrgEvents = (
  $: OmitValueWhenNever<{
    query: activityListPublicOrgEvents_Query;
    querystring: never;
    path: activityListPublicOrgEvents_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type activityListPublicOrgEvents_Query = {
  per_page?: number;
  page?: number;
};

export type activityListPublicOrgEvents_Path = { org: string };
