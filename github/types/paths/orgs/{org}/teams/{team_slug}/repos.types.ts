...
export type teamsListReposInOrg = (
  $: OmitValueWhenNever<{
    query: teamsListReposInOrg_Query;
    querystring: never;
    path: teamsListReposInOrg_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type teamsListReposInOrg_Query = { per_page?: number; page?: number };

export type teamsListReposInOrg_Path = { org: string; team_slug: string };
