...
export type orgsListPatGrantRepositories = (
  $: OmitValueWhenNever<{
    query: orgsListPatGrantRepositories_Query;
    querystring: never;
    path: orgsListPatGrantRepositories_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type orgsListPatGrantRepositories_Query = {
  per_page?: number;
  page?: number;
};

export type orgsListPatGrantRepositories_Path = {
  org: string;
  /**
