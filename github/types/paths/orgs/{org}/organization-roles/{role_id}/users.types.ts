...
import type { user_role_assignment } from "../../../../../components/schemas/user-role-assignment.js";
...
export type orgsListOrgRoleUsers = (
  $: OmitValueWhenNever<{
    query: orgsListOrgRoleUsers_Query;
    querystring: never;
    path: orgsListOrgRoleUsers_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: Array<user_role_assignment>;
          };
        };
        examples: {
          default: unknown;
...
export type orgsListOrgRoleUsers_Query = { per_page?: number; page?: number };

export type orgsListOrgRoleUsers_Path = { org: string; role_id: number };
