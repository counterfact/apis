...
import type { tag } from "../../../../components/schemas/tag.js";

export type reposListTags = (
  $: OmitValueWhenNever<{
    query: reposListTags_Query;
    querystring: never;
    path: reposListTags_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type reposListTags_Query = { per_page?: number; page?: number };

export type reposListTags_Path = { owner: string; repo: string };
