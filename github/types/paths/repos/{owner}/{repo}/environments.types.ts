...
export type reposGetAllEnvironments = (
  $: OmitValueWhenNever<{
    query: reposGetAllEnvironments_Query;
    querystring: never;
    path: reposGetAllEnvironments_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type reposGetAllEnvironments_Query = {
  per_page?: number;
  page?: number;
};

export type reposGetAllEnvironments_Path = { owner: string; repo: string };
