...
export type codespacesGetRepoSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: codespacesGetRepoSecret_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type codespacesCreateOrUpdateRepoSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: codespacesCreateOrUpdateRepoSecret_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type codespacesDeleteRepoSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: codespacesDeleteRepoSecret_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type codespacesGetRepoSecret_Path = {
  owner: string;
  repo: string;
  secret_name: string;
};

export type codespacesCreateOrUpdateRepoSecret_Path = {
  owner: string;
  repo: string;
  secret_name: string;
};

export type codespacesDeleteRepoSecret_Path = {
  owner: string;
  repo: string;
  secret_name: string;
};
