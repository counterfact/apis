...
import type { actions_cache_retention_limit_for_repository } from "../../../../../../components/schemas/actions-cache-retention-limit-for-repository.js";
 ...
 */
export type actionsGetActionsCacheRetentionLimitForRepository = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsGetActionsCacheRetentionLimitForRepository_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: actions_cache_retention_limit_for_repository;
          };
        };
        examples: {
          default: unknown;
 ...
 * OAuth tokens and personal access tokens (classic) need the `admin:repository` scope to use this endpoint.
 */
export type actionsSetActionsCacheRetentionLimitForRepository = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsSetActionsCacheRetentionLimitForRepository_Path;
    headers: never;
    cookie: never;
    body: actions_cache_retention_limit_for_repository;
    context: Context;
    response: ResponseBuilderFactory<{
      204: {
        headers: never;
...
export type actionsGetActionsCacheRetentionLimitForRepository_Path = {
  owner: string;
  repo: string;
};

export type actionsSetActionsCacheRetentionLimitForRepository_Path = {
  owner: string;
  repo: string;
};
