...
export type actionsListRepoOrganizationSecrets = (
  $: OmitValueWhenNever<{
    query: actionsListRepoOrganizationSecrets_Query;
    querystring: never;
    path: actionsListRepoOrganizationSecrets_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type actionsListRepoOrganizationSecrets_Query = {
  per_page?: number;
  page?: number;
};

export type actionsListRepoOrganizationSecrets_Path = {
  owner: string;
  repo: string;
};
