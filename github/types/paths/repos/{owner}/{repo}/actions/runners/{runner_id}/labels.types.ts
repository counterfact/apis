...
export type actionsListLabelsForSelfHostedRunnerForRepo = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsListLabelsForSelfHostedRunnerForRepo_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type actionsAddCustomLabelsToSelfHostedRunnerForRepo = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsAddCustomLabelsToSelfHostedRunnerForRepo_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type actionsSetCustomLabelsForSelfHostedRunnerForRepo = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsSetCustomLabelsForSelfHostedRunnerForRepo_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type actionsRemoveAllCustomLabelsFromSelfHostedRunnerForRepo = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsRemoveAllCustomLabelsFromSelfHostedRunnerForRepo_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type actionsListLabelsForSelfHostedRunnerForRepo_Path = {
  owner: string;
  repo: string;
  runner_id: number;
};

export type actionsAddCustomLabelsToSelfHostedRunnerForRepo_Path = {
  owner: string;
  repo: string;
  runner_id: number;
};

export type actionsSetCustomLabelsForSelfHostedRunnerForRepo_Path = {
  owner: string;
  repo: string;
  runner_id: number;
};

export type actionsRemoveAllCustomLabelsFromSelfHostedRunnerForRepo_Path = {
  owner: string;
  repo: string;
  runner_id: number;
};
