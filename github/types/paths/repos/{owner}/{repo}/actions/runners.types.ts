...
export type actionsListSelfHostedRunnersForRepo = (
  $: OmitValueWhenNever<{
    query: actionsListSelfHostedRunnersForRepo_Query;
    querystring: never;
    path: actionsListSelfHostedRunnersForRepo_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type actionsListSelfHostedRunnersForRepo_Query = {
  /**
...
export type actionsListSelfHostedRunnersForRepo_Path = {
  owner: string;
  repo: string;
};
