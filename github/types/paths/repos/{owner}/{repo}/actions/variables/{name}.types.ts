...
export type actionsGetRepoVariable = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsGetRepoVariable_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type actionsUpdateRepoVariable = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsUpdateRepoVariable_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type actionsDeleteRepoVariable = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsDeleteRepoVariable_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type actionsGetRepoVariable_Path = {
  owner: string;
  repo: string;
  name: string;
};

export type actionsUpdateRepoVariable_Path = {
  owner: string;
  repo: string;
  name: string;
};

export type actionsDeleteRepoVariable_Path = {
  owner: string;
  repo: string;
  name: string;
};
