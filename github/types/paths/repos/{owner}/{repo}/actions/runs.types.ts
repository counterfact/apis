...
export type actionsListWorkflowRunsForRepo = (
  $: OmitValueWhenNever<{
    query: actionsListWorkflowRunsForRepo_Query;
    querystring: never;
    path: actionsListWorkflowRunsForRepo_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type actionsListWorkflowRunsForRepo_Query = {
  actor?: string;
  branch?: string;
  event?: string;
  status?:
...
export type actionsListWorkflowRunsForRepo_Path = {
  owner: string;
  repo: string;
};
