...
import type { environment_approvals } from "../../../../../../../components/schemas/environment-approvals.js";
...
export type actionsGetReviewsForRun = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: actionsGetReviewsForRun_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: Array<environment_approvals>;
          };
        };
        examples: {
          default: unknown;
...
export type actionsGetReviewsForRun_Path = {
  owner: string;
  repo: string;
  run_id: number;
};
