...
export type actionsListJobsForWorkflowRun = (
  $: OmitValueWhenNever<{
    query: actionsListJobsForWorkflowRun_Query;
    querystring: never;
    path: actionsListJobsForWorkflowRun_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type actionsListJobsForWorkflowRun_Query = {
  /**
...
export type actionsListJobsForWorkflowRun_Path = {
  owner: string;
  repo: string;
  run_id: number;
};
