...
export type actionsListWorkflowRunArtifacts = (
  $: OmitValueWhenNever<{
    query: actionsListWorkflowRunArtifacts_Query;
    querystring: never;
    path: actionsListWorkflowRunArtifacts_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type actionsListWorkflowRunArtifacts_Query = {
  per_page?: number;
  page?: number;
  name?: string;
  direction?: "asc" | "desc";
...
export type actionsListWorkflowRunArtifacts_Path = {
  owner: string;
  repo: string;
  run_id: number;
};
