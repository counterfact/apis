...
export type reposGetAdminBranchProtection = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: reposGetAdminBranchProtection_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type reposSetAdminBranchProtection = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: reposSetAdminBranchProtection_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type reposDeleteAdminBranchProtection = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: reposDeleteAdminBranchProtection_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type reposGetAdminBranchProtection_Path = {
  owner: string;
  repo: string;
  branch: string;
};

export type reposSetAdminBranchProtection_Path = {
  owner: string;
  repo: string;
  branch: string;
};

export type reposDeleteAdminBranchProtection_Path = {
  owner: string;
  repo: string;
  branch: string;
};
