...
import type { code_security_configuration_for_repository } from "../../../../components/schemas/code-security-configuration-for-repository.js";
...
export type codeSecurityGetConfigurationForRepository = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: codeSecurityGetConfigurationForRepository_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: code_security_configuration_for_repository;
          };
        };
        examples: {
          default: unknown;
...
export type codeSecurityGetConfigurationForRepository_Path = {
  owner: string;
  repo: string;
};
