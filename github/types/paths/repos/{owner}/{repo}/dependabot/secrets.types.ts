...
export type dependabotListRepoSecrets = (
  $: OmitValueWhenNever<{
    query: dependabotListRepoSecrets_Query;
    querystring: never;
    path: dependabotListRepoSecrets_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: { total_count: number; secrets: Array<dependabot_secret> };
          };
        };
        examples: {
          default: unknown;
...
export type dependabotListRepoSecrets_Query = {
  per_page?: number;
  page?: number;
};

export type dependabotListRepoSecrets_Path = { owner: string; repo: string };
