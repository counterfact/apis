...
export type issuesGetComment_Path = {
  owner: string;
  repo: string;
  comment_id: number;
};

export type issuesUpdateComment_Path = {
  owner: string;
  repo: string;
  comment_id: number;
};

export type issuesDeleteComment_Path = {
  owner: string;
  repo: string;
  comment_id: number;
};
