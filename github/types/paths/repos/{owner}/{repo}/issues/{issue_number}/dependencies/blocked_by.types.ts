 ...
 */
export type issuesListDependenciesBlockedBy = (
  $: OmitValueWhenNever<{
    query: issuesListDependenciesBlockedBy_Query;
    querystring: never;
    path: issuesListDependenciesBlockedBy_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
 ...
 * - **`application/vnd.github.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.
 */
export type issuesAddBlockedByDependency = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: issuesAddBlockedByDependency_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type issuesListDependenciesBlockedBy_Query = {
  per_page?: number;
  page?: number;
};

export type issuesListDependenciesBlockedBy_Path = {
  owner: string;
  repo: string;
  issue_number: number;
};

export type issuesAddBlockedByDependency_Path = {
  owner: string;
  repo: string;
  issue_number: number;
};
