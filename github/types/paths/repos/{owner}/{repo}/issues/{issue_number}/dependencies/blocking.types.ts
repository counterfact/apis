 ...
 */
export type issuesListDependenciesBlocking = (
  $: OmitValueWhenNever<{
    query: issuesListDependenciesBlocking_Query;
    querystring: never;
    path: issuesListDependenciesBlocking_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type issuesListDependenciesBlocking_Query = {
  per_page?: number;
  page?: number;
};

export type issuesListDependenciesBlocking_Path = {
  owner: string;
  repo: string;
  issue_number: number;
};
