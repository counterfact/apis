...
export type pullsListReviewCommentsForRepo = (
  $: OmitValueWhenNever<{
    query: pullsListReviewCommentsForRepo_Query;
    querystring: never;
    path: pullsListReviewCommentsForRepo_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type pullsListReviewCommentsForRepo_Query = {
...
export type pullsListReviewCommentsForRepo_Path = {
  owner: string;
  repo: string;
};
