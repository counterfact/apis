...
import type { commit_comparison } from "../../../../../components/schemas/commit-comparison.js";
...
export type reposCompareCommits = (
  $: OmitValueWhenNever<{
    query: reposCompareCommits_Query;
    querystring: never;
    path: reposCompareCommits_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type reposCompareCommits_Query = { page?: number; per_page?: number };

export type reposCompareCommits_Path = {
  owner: string;
  repo: string;
  /**
