...
export type activityListRepoEvents = (
  $: OmitValueWhenNever<{
    query: activityListRepoEvents_Query;
    querystring: never;
    path: activityListRepoEvents_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type activityListRepoEvents_Query = { per_page?: number; page?: number };

export type activityListRepoEvents_Path = { owner: string; repo: string };
