...
export type actionsListEnvironmentSecrets = (
  $: OmitValueWhenNever<{
    query: actionsListEnvironmentSecrets_Query;
    querystring: never;
    path: actionsListEnvironmentSecrets_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type actionsListEnvironmentSecrets_Query = {
  per_page?: number;
  page?: number;
};

export type actionsListEnvironmentSecrets_Path = {
  owner: string;
  repo: string;
