...
import type { referrer_traffic } from "../../../../../../components/schemas/referrer-traffic.js";
...
export type reposGetTopReferrers = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: reposGetTopReferrers_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type reposGetTopReferrers_Path = { owner: string; repo: string };
