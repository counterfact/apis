...
import type { content_traffic } from "../../../../../../components/schemas/content-traffic.js";
...
export type reposGetTopPaths_Path = { owner: string; repo: string };
