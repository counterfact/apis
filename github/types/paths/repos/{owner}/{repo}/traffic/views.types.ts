...
import type { view_traffic } from "../../../../../components/schemas/view-traffic.js";
...
export type reposGetViews = (
  $: OmitValueWhenNever<{
    query: reposGetViews_Query;
    querystring: never;
    path: reposGetViews_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type reposGetViews_Query = { per?: "day" | "week" };

export type reposGetViews_Path = { owner: string; repo: string };
