 ...
 */
export type agentsListRepoSecrets = (
  $: OmitValueWhenNever<{
    query: agentsListRepoSecrets_Query;
    querystring: never;
    path: agentsListRepoSecrets_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type agentsListRepoSecrets_Query = { per_page?: number; page?: number };

export type agentsListRepoSecrets_Path = { owner: string; repo: string };
