 ...
 */
export type agentsListRepoVariables = (
  $: OmitValueWhenNever<{
    query: agentsListRepoVariables_Query;
    querystring: never;
    path: agentsListRepoVariables_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
 ...
 */
export type agentsCreateRepoVariable = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: agentsCreateRepoVariable_Path;
    headers: never;
    cookie: never;
    body: {
      /**
...
export type agentsListRepoVariables_Query = {
  per_page?: number;
  page?: number;
};

export type agentsListRepoVariables_Path = { owner: string; repo: string };

export type agentsCreateRepoVariable_Path = { owner: string; repo: string };
