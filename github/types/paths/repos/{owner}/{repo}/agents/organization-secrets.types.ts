 ...
 */
export type agentsListRepoOrganizationSecrets = (
  $: OmitValueWhenNever<{
    query: agentsListRepoOrganizationSecrets_Query;
    querystring: never;
    path: agentsListRepoOrganizationSecrets_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type agentsListRepoOrganizationSecrets_Query = {
  per_page?: number;
  page?: number;
};

export type agentsListRepoOrganizationSecrets_Path = {
  owner: string;
  repo: string;
};
