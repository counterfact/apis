 ...
 */
export type agentsListRepoOrganizationVariables = (
  $: OmitValueWhenNever<{
    query: agentsListRepoOrganizationVariables_Query;
    querystring: never;
    path: agentsListRepoOrganizationVariables_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type agentsListRepoOrganizationVariables_Query = {
  per_page?: number;
  page?: number;
};

export type agentsListRepoOrganizationVariables_Path = {
  owner: string;
  repo: string;
};
