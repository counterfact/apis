 ...
 */
export type agentsGetRepoSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: agentsGetRepoSecret_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
 ...
 */
export type agentsCreateOrUpdateRepoSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: agentsCreateOrUpdateRepoSecret_Path;
    headers: never;
    cookie: never;
    body: {
      /**
 ...
 * OAuth tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.
 */
export type agentsDeleteRepoSecret = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: agentsDeleteRepoSecret_Path;
    headers: never;
    cookie: never;
    body: never;
    context: Context;
...
export type agentsGetRepoSecret_Path = {
  owner: string;
  repo: string;
  secret_name: string;
};

export type agentsCreateOrUpdateRepoSecret_Path = {
  owner: string;
  repo: string;
  secret_name: string;
};

export type agentsDeleteRepoSecret_Path = {
  owner: string;
  repo: string;
  secret_name: string;
};
