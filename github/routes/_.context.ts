  ...
  saveWorkflowRun(
    ...
    const run: workflow_run = {
      ...
      repository: {
        ...
        node_id: state.repository.node_id,
        ...
        html_url: state.repository.html_url,
        description: state.repository.description,
        fork: state.repository.fork,
        url: state.repository.url,
        archive_url: state.repository.archive_url,
        assignees_url: state.repository.assignees_url,
        blobs_url: state.repository.blobs_url,
        branches_url: state.repository.branches_url,
        collaborators_url: state.repository.collaborators_url,
        comments_url: state.repository.comments_url,
        commits_url: state.repository.commits_url,
        compare_url: state.repository.compare_url,
        contents_url: state.repository.contents_url,
        contributors_url: state.repository.contributors_url,
        deployments_url: state.repository.deployments_url,
        downloads_url: state.repository.downloads_url,
        events_url: state.repository.events_url,
        forks_url: state.repository.forks_url,
        git_commits_url: state.repository.git_commits_url,
        git_refs_url: state.repository.git_refs_url,
        git_tags_url: state.repository.git_tags_url,
        git_url: state.repository.git_url,
        issue_comment_url: state.repository.issue_comment_url,
        issue_events_url: state.repository.issue_events_url,
        issues_url: state.repository.issues_url,
        keys_url: state.repository.keys_url,
        labels_url: state.repository.labels_url,
        languages_url: state.repository.languages_url,
        merges_url: state.repository.merges_url,
        milestones_url: state.repository.milestones_url,
        notifications_url: state.repository.notifications_url,
        pulls_url: state.repository.pulls_url,
        releases_url: state.repository.releases_url,
        ssh_url: state.repository.ssh_url,
        stargazers_url: state.repository.stargazers_url,
        statuses_url: state.repository.statuses_url,
        subscribers_url: state.repository.subscribers_url,
        subscription_url: state.repository.subscription_url,
        tags_url: state.repository.tags_url,
        teams_url: state.repository.teams_url,
        trees_url: state.repository.trees_url,
        clone_url: state.repository.clone_url,
        mirror_url: state.repository.mirror_url,
        hooks_url: state.repository.hooks_url,
        svn_url: state.repository.svn_url,
        homepage: state.repository.homepage,
        language: state.repository.language,
        forks_count: state.repository.forks_count,
        stargazers_count: state.repository.stargazers_count,
        watchers_count: state.repository.watchers_count,
        size: state.repository.size,
        default_branch: state.repository.default_branch,
        open_issues_count: state.repository.open_issues_count,
        is_template: state.repository.is_template,
        topics: state.repository.topics,
        has_issues: state.repository.has_issues,
        has_projects: state.repository.has_projects,
        has_wiki: state.repository.has_wiki,
        has_pages: state.repository.has_pages,
        has_downloads: state.repository.has_downloads,
        has_discussions: state.repository.has_discussions,
        archived: state.repository.archived,
        disabled: state.repository.disabled,
        visibility: state.repository.visibility,
        pushed_at: state.repository.pushed_at,
        created_at: state.repository.created_at,
        updated_at: state.repository.updated_at,
        permissions: state.repository.permissions,
        allow_rebase_merge: state.repository.allow_rebase_merge,
        allow_squash_merge: state.repository.allow_squash_merge,
        allow_auto_merge: state.repository.allow_auto_merge,
        delete_branch_on_merge: state.repository.delete_branch_on_merge,
        allow_merge_commit: state.repository.allow_merge_commit,
        allow_update_branch: state.repository.allow_update_branch,
        use_squash_pr_title_as_default:
        ...
        forks: state.repository.forks,
        open_issues: state.repository.open_issues,
        watchers: state.repository.watchers,
      },
      head_repository: {
        id: state.repository.id,
        node_id: state.repository.node_id,
