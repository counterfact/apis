...
/**
 * Changes the shipping address associated with a subscription. Source reviewed
 * 2026-08-02:
 * https://developer.ordergroove.com/reference/subscriptions-change-shipping-address
 *
 */
export type subscriptionsChangeShippingAddress = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: subscriptionsChangeShippingAddress_Path;
    headers: subscriptionsChangeShippingAddress_Headers;
    cookie: never;
...
export type subscriptionsChangeShippingAddress_Path = {
  subscription_id: string;
};

export type subscriptionsChangeShippingAddress_Headers = {
  "x-api-key": string;
