...
/**
 * Changes the payment method and associated billing address for an individual
 * order. Source reviewed 2026-08-02:
 * https://developer.ordergroove.com/reference/orders-change-payment
 *
 */
export type ordersChangePayment = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: ordersChangePayment_Path;
    headers: ordersChangePayment_Headers;
    cookie: never;
    body: { payment: string };
    context: Context;
...
export type ordersChangePayment_Path = { order_id: string };

export type ordersChangePayment_Headers = {
  "x-api-key": string;
